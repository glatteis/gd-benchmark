...
for model in color_map:
    custom_legend.append(Line2D([0], [0], marker=marker_map[model], color=color_map[model], label=model, ls=""))
...
for i in range(len(x)):
    ax.scatter([x[i]], [y[i]], c=[colors[i]], marker=markers[i], s=[160], zorder=1000, alpha=0.65)
    # if args.one_vs_all:
    # else:
...
if args.seperate_legend:
    ...
    figlegend.legend(handles=custom_legend)
