...
do
	python3 csv_to_scatter.py vmcai-paper-bench/constraints.csv "lr=0.1 Project with gradient" "lr=0.1 Logarithmic Barrier,lr=0.1 Logistic Sigmoid,lr=0.01 Project with gradient,lr=0.01 Logarithmic Barrier,lr=0.01 Logistic Sigmoid,lr=0.001 Project with gradient,lr=0.001 Logarithmic Barrier,lr=0.001 Logistic Sigmoid" "lr=0.1 Project with gradient" "Others" --comp-field "Add. Settings" --filter "Method:$method" --one-vs-all True --output-pdf vmcai-paper-bench/pdfs/$method-constraints.pdf --seperate-legend True --symbols True
done
...
python3 csv_to_scatter.py vmcai-paper-bench/method_comparison.csv "momentum-sign" "momentum" "Momentum-Sign" "Momentum" --comp-field "Method" --filter "Add. Settings:Project with gradient" --output-pdf vmcai-paper-bench/pdfs/momentum-sign-vs-momentum.pdf --seperate-legend True
# momentum-sign vs nesterov-sign (with gradient projection)
python3 csv_to_scatter.py vmcai-paper-bench/method_comparison.csv "momentum-sign" "nesterov-sign" "Momentum-Sign" "Nesterov-Sign" --comp-field "Method" --filter "Add. Settings:Project with gradient" --output-pdf vmcai-paper-bench/pdfs/momentum-sign-vs-nesterov-sign-project-with-gradient.pdf --seperate-legend True
