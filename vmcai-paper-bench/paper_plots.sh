...
do
	...
	python3 csv_to_scatter.py vmcai-paper-bench/constraints.csv "lr=0.1 Project" "lr=0.1 Logarithmic Barrier,lr=0.1 Logistic Sigmoid,lr=0.01 Project,lr=0.01 Logarithmic Barrier,lr=0.01 Logistic Sigmoid,lr=0.001 Project,lr=0.001 Logarithmic Barrier,lr=0.001 Logistic Sigmoid" "lr=0.1 Project" "Others" --comp-field "Add. Settings" --filter "Method:$method" --one-vs-all True --output-pdf vmcai-paper-bench/pdfs/$lower_method-constraints.pdf --seperate-legend True --symbols True
done

# methods against each other with projected with gradient
python3 csv_to_scatter.py vmcai-paper-bench/method_comparison.csv "Momentum-Sign" "ADAM,RADAM,RMSProp,Plain,Plain-Sign,Momentum,Nesterov,Nesterov-Sign" "Momentum-Sign" "Others" --comp-field "Method" --filter "Add. Settings:Project" --one-vs-all True --output-pdf vmcai-paper-bench/pdfs/method-comparison-project-with-gradient.pdf

# Momentum-Sign vs momentum (fig 5)
python3 csv_to_scatter.py vmcai-paper-bench/method_comparison.csv "Momentum-Sign" "Momentum" "Momentum-Sign" "Momentum" --comp-field "Method" --filter "Add. Settings:Project" --output-pdf vmcai-paper-bench/pdfs/momentum-sign-vs-momentum.pdf --seperate-legend True
# Momentum-Sign vs Nesterov-Sign (with gradient projection)
python3 csv_to_scatter.py vmcai-paper-bench/method_comparison.csv "Momentum-Sign" "Nesterov-Sign" "Momentum-Sign" "Nesterov-Sign" --comp-field "Method" --filter "Add. Settings:Project" --output-pdf vmcai-paper-bench/pdfs/momentum-sign-vs-nesterov-sign-project-with-gradient.pdf --seperate-legend True
